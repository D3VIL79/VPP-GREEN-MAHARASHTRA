      ...
      <div className="space-y-6">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="facultyId" defaultValue={user?.id ? `VPP-FAC-${user.id.slice(0, 8).toUpperCase()}` : "VPP-FAC-TEMP"} disabled className="bg-background/50 opacity-70 cursor-not-allowed" />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="department" defaultValue={`${user?.departmentId || 'General'} (${user?.role || 'FACULTY'})`} disabled className="bg-background/50 opacity-70 cursor-not-allowed" />
              </div>
            </div>
            <div className="flex justify-end pt-2">
              <Button className="bg-primary hover:bg-primary/95 text-white" onClick={handleSaveProfile}>
        ...
        <Card className="border-border/50 bg-card/60 backdrop-blur-xl shadow-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end pt-2">
              <Button className="bg-primary hover:bg-primary/95 text-white" onClick={handleSavePreferences}>
